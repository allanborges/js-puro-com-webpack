...
const criaCorpoTabela = (tabela) => {
  ...
  const exibeCliente = (cpf, nome, id) => {
    ...
    <td>${cpf}</td>
    <td>${nome}</td>    
    <button type=""button class="btn btn-info" onclick="navegacao('/edita?id=${id}'); return;">Editar</button>   
`
...
const inicializaTabela = () => {
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col"></th>
      <th scope="col"><a class="btn btn-primary" onclick="navegacao('/cadastro');return;">Novo Cliente</a>
      </th>
    </tr>
  </thead>
`;
